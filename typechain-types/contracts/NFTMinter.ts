...
export interface NFTMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MINT_PRICE"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "updateFactoryContract",
    values: [AddressLike]
  ): string;
...
export interface NFTMinter extends BaseContract {
  connect(runner?: ContractRunner | null): NFTMinter;
  ...
  mintToCollection: TypedContractMethod<
    [to: AddressLike, collectionId: BigNumberish, tokenURI: string],
    [void],
    "payable"
  >;
  ...
  updateFactoryContract: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "updateFactoryContract"
  ...
  filters: {
    ...
    "FactoryContractUpdated(address,address)": TypedContractEvent<
      FactoryContractUpdatedEvent.InputTuple,
      FactoryContractUpdatedEvent.OutputTuple,
      FactoryContractUpdatedEvent.OutputObject
    >;
